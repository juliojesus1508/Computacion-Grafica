...
void Edges::solveEdges(TCube &cube) {
...
void Edges::solveEdge(TCube &cube) {
  if (cube.cubies[1][1] != 1 && cube.cubies[1][4] != 1) {
    if (cube.cubies[1][1] == 2) {
      if (cube.cubies[1][4] == 3) {
        edges_moves += cube.moves("URRRUUURRRUUURRRURUR");
      }
      else if (cube.cubies[1][4] == 5) {
        edges_moves += cube.moves("BUBUBUUUBBBUUUBBB");
      }
    }
    else if (cube.cubies[1][1] == 3) {
      if (cube.cubies[1][4] == 4) {
        edges_moves += cube.moves("BBBUUUBBBUUUBBBUBUB");
      }
      else if (cube.cubies[1][4] == 2) {
        edges_moves += cube.moves("UUFUFUFUUUFFFUUUFFF");
      }
    }
    else if (cube.cubies[1][1] == 4) {
      if (cube.cubies[1][4] == 5) {
        edges_moves += cube.moves("UUULLLUUULLLUUULLLULUL");
      }
      ...
      if (cube.cubies[1][4] == 2) {
        edges_moves += cube.moves("UUFFFUUUFFFUUUFFFUFUF");
      }
      else if (cube.cubies[1][4] == 4) {
        edges_moves += cube.moves("LLLUUULLLUUULLLULUL");
      }
    }
  }
    ...
    if (cube.cubies[5][1] == 2) {
      if (cube.cubies[1][3] == 3) {
        edges_moves += cube.moves("RRRUUURRRUUURRRURUR");
      }
      else if (cube.cubies[1][3] == 5) {
        edges_moves += cube.moves("UULULULUUULLLUUULLL");
      }
    }
    else if (cube.cubies[5][1] == 3) {
      if (cube.cubies[1][3] == 4) {
        edges_moves += cube.moves("UUUBBBUUUBBBUUUBBBUBUB");
      }
      else if (cube.cubies[1][3] == 2) {
        edges_moves += cube.moves("UFUFUFUUUFFFUUUFFF");
      }
    }
    else if (cube.cubies[5][1] == 4) {
      if (cube.cubies[1][3] == 5) {
        edges_moves += cube.moves("UULLLUUULLLUUULLLULUL");
      }
      else if (cube.cubies[1][3] == 3) {
        edges_moves += cube.moves("RURURUUURRRUUURRR");
      }
    }
    else if (cube.cubies[5][1] == 5) {
      if (cube.cubies[1][3] == 2) {
        edges_moves += cube.moves("UFFFUUUFFFUUUFFFUFUF");
      }
      else if (cube.cubies[1][3] == 4) {
        edges_moves += cube.moves("UUUBUBUBUUUBBBUUUBBB");
      }
    }
  }
    ...
    if (cube.cubies[7][1] == 2) {
      if (cube.cubies[1][2] == 3) {
        edges_moves += cube.moves("UUURRRUUURRRUUURRRURUR");
      }
      else if (cube.cubies[1][2] == 5) {
        edges_moves += cube.moves("ULULULUUULLLUUULLL");
      }
    }
    else if (cube.cubies[7][1] == 3) {
      if (cube.cubies[1][2] == 4) {
        edges_moves += cube.moves("UUBBBUUUBBBUUUBBBUBUB");
      }
      else if (cube.cubies[1][2] == 2) {
        edges_moves += cube.moves("FUFUFUUUFFFUUUFFF");
      }
    }
    else if (cube.cubies[7][1] == 4) {
      if (cube.cubies[1][2] == 5) {
        edges_moves += cube.moves("ULLLUUULLLUUULLLULUL");
      }
      else if (cube.cubies[1][2] == 3) {
        edges_moves += cube.moves("UUURURURUUURRRUUURRR");
      }
    }
    else if (cube.cubies[7][1] == 5) {
      if (cube.cubies[1][2] == 2) {
        edges_moves += cube.moves("FFFUUUFFFUUUFFFUFUF");
      }
      else if (cube.cubies[1][2] == 4) {
        edges_moves += cube.moves("UUBUBUBUUUBBBUUUBBB");
      }
    }
  }
    ...
    if (cube.cubies[3][1] == 2) {
      if (cube.cubies[1][5] == 3) {
        edges_moves += cube.moves("UURRRUUURRRUUURRRURUR");
      }
      else if (cube.cubies[1][5] == 5) {
        edges_moves += cube.moves("LULULUUULLLUUULLL");
      }
    }
    else if (cube.cubies[3][1] == 3) {
      if (cube.cubies[1][5] == 4) {
        edges_moves += cube.moves("UBBBUUUBBBUUUBBBUBUB");
      }
      else if (cube.cubies[1][5] == 2) {
        edges_moves += cube.moves("UUUFUFUFUUUFFFUUUFFF");
      }
    }
      ...
      if (cube.cubies[1][5] == 5) {
        ...
        edges_moves += cube.moves("UURURURUUURRRUUURRR");
      }
    }
    else if (cube.cubies[3][1] == 5) {
      if (cube.cubies[1][5] == 2) {
        edges_moves += cube.moves("UUUFFFUUUFFFUUUFFFUFUF");
      }
      else if (cube.cubies[1][5] == 4) {
        edges_moves += cube.moves("UBUBUBUUUBBBUUUBBB");
      }
    }
  }
...
int Edges::checkEdges(TCube &cube) {
